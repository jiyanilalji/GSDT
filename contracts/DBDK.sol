...
/**
 * @title DBDK Stablecoin with Enhanced Security
 * @dev Implementation of the Da BRICS Digital Koin (DBDK) stablecoin with advanced security features
 */
contract DBDK is ERC20Pausable, AccessControl, ReentrancyGuard {
    ...
    // Security limits
    uint256 public constant MIN_MINT_AMOUNT = 100 * 10**18; // 100 DBDK
    uint256 public constant MAX_MINT_AMOUNT = 1000000 * 10**18; // 1M DBDK
    uint256 public dailyMintLimit = 10000000 * 10**18; // 10M DBDK
    uint256 public dailyRedemptionLimit = 10000000 * 10**18; // 10M DBDK
    ...
    constructor() ERC20("Da BRICS Digital Koin", "DBDK") {
